...
public enum Spices {
    ...
    AMETHYST_NIGELLA_SEEDS(4, ItemRegistry.SPICE_AMETHYST_NIGELLA_SEEDS.get(), Flavors.AROMITIC),
    CITRINE_NIGELLA_SEEDS(5, ItemRegistry.SPICE_CITRINE_NIGELLA_SEEDS.get(), Flavors.AROMITIC1),
